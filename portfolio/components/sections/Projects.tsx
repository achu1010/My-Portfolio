...
function ProjectCard({ title, year, institution, description, tools, githubLink, isSmall = false, hasScreenshots = false, onViewScreenshots }: ProjectCardProps) {
  return (
...
export default function Projects() {
  ...
  const spamSMSScreenshots = [
    '/images/Spam_SMS/Image1.png',
    '/images/Spam_SMS/Image2.png',
    '/images/Spam_SMS/Image3.png',
    '/images/Spam_SMS/Image4.png',
    '/images/Spam_SMS/Image5.png',
  ];
  
  const promptFilterScreenshots = [
    '/images/prompt_filter/image1.png',
    '/images/prompt_filter/image2.png',
    '/images/prompt_filter/workflow.png',
  ];
  
  const multilingualPromptFilterScreenshots = [
    '/images/Multilingual_prompt_filter/image1.png',
    '/images/Multilingual_prompt_filter/image2.png',
    '/images/Multilingual_prompt_filter/image3.png',
    '/images/Multilingual_prompt_filter/image4.png',
    '/images/Multilingual_prompt_filter/image5.png',
    '/images/Multilingual_prompt_filter/image6.png',
  ];
  
  const openGallery = (projectName: string, images: string[]) => {
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-14">
          <ProjectCard 
            ...
            hasScreenshots={true}
            onViewScreenshots={() => openGallery('Multilingual Prompt Filtering For LLM Security', multilingualPromptFilterScreenshots)}
          />
          ...
          <ProjectCard 
            ...
            hasScreenshots={true}
            onViewScreenshots={() => openGallery('Prompt Filtering For LLM Security', promptFilterScreenshots)}
          />
          ...
          <ProjectCard 
            ...
            hasScreenshots={true}
            onViewScreenshots={() => openGallery('Spam SMS Detection', spamSMSScreenshots)}
          />
        </div>
